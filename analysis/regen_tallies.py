...
print("=" * 70)
REFUTED = ["IR-specificity of the horizon coupling (P2/F3, run 12)",
           "f3 and f3n non-spectral coherence gates (F2 run 11 / F4 run 12)",
           "H-I: mass grows toward the horizon (F5, run 14)",
           ...
           "'lambda is constant across three spacings' (assembly audit, 2026-08-20)",
           "the plateau r = -0.51..-0.53 (P8 blind failure at n=256, run 17)",
           "'the correlation peaks then declines in coherence' (audit of our own"
           " correction: S4 is 58% of the weight; deep band is 100% beta=2.6)",
           "H-II: mass grows away from the horizon (closed unresolved, run 17)"]
for line in REFUTED:
    print(f"  - {line}")
print(f"  COUNT: {len(REFUTED)} refuted or withdrawn in this record "
      f"({sum('audit' in x for x in REFUTED)} caught by this record's own audits)")
